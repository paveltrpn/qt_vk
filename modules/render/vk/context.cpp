...
namespace tire::vk {
    ...
    Context::Context(ANativeWindow *window)
            : window_{window} {
    }
    ...
    uint32_t Context::memoryRequirements(uint32_t typeFilter,
        ...
        throw std::runtime_error(
                std::format("failed to find suitable memory type!"));
